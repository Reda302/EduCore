...
export const generateCalendarEvents = () => {
  ...
  const getDayOffset = (dayOffset: number, hour: number, minute: number) => {
  ...
  return [
    ...
    {
      title: "Math",
      start: getDayOffset(0, 8, 0),
      end: getDayOffset(0, 8, 45),
    },
    {
      title: "English",
      start: getDayOffset(0, 9, 0),
      end: getDayOffset(0, 9, 45),
    },
    {
      title: "Biology",
      start: getDayOffset(0, 10, 0),
      end: getDayOffset(0, 10, 45), 
    },
    {
      title: "Physics",
      start: getDayOffset(0, 11, 0),
      end: getDayOffset(0, 11, 45),
    },
    {
      title: "Chemistry",
      start: getDayOffset(0, 13, 0),
      end: getDayOffset(0, 13, 45),
    },
    {
      title: "History",
      start: getDayOffset(0, 14, 0),
      end: getDayOffset(0, 14, 45),
    },

    // Tuesday
    {
      title: "English",
      start: getDayOffset(1, 9, 0),
      end: getDayOffset(1, 9, 45),
    },
    {
      title: "Biology",
      start: getDayOffset(1, 10, 0),
      end: getDayOffset(1, 10, 45),
    },
    {
      title: "Physics",
      start: getDayOffset(1, 11, 0),
      end: getDayOffset(1, 11, 45),
    },
    {
      title: "History",
      start: getDayOffset(1, 14, 0),
      end: getDayOffset(1, 14, 45),
    },

    // Wednesday
    {
      title: "Math",
      start: getDayOffset(2, 8, 0),
      end: getDayOffset(2, 8, 45),
    },
    {
      title: "Biology",
      start: getDayOffset(2, 10, 0),
      end: getDayOffset(2, 10, 45),
    },
    {
      title: "Chemistry",
      start: getDayOffset(2, 13, 0),
      end: getDayOffset(2, 13, 45),
    },
    {
      title: "History",
      start: getDayOffset(2, 14, 0),
      end: getDayOffset(2, 14, 45),
    },

    // Thursday
    {
      title: "English",
      start: getDayOffset(3, 9, 0),
      end: getDayOffset(3, 9, 45),
    },
    {
      title: "Biology",
      start: getDayOffset(3, 10, 0),
      end: getDayOffset(3, 10, 45),
    },
    {
      title: "Physics",
      start: getDayOffset(3, 11, 0),
      end: getDayOffset(3, 11, 45),
    },
    {
      title: "History",
      start: getDayOffset(3, 14, 0),
      end: getDayOffset(3, 14, 45),
    },

    // Friday
    {
      title: "Math",
      start: getDayOffset(4, 8, 0),
      end: getDayOffset(4, 8, 45),
    },
    {
      title: "English",
      start: getDayOffset(4, 9, 0),
      end: getDayOffset(4, 9, 45),
    },
    {
      title: "Physics",
      start: getDayOffset(4, 11, 0),
      end: getDayOffset(4, 11, 45),
    },
    {
      title: "Chemistry",
      start: getDayOffset(4, 13, 0),
      end: getDayOffset(4, 13, 45),
    },
    {
      title: "History",
      start: getDayOffset(4, 14, 0),
      end: getDayOffset(4, 14, 45),
    },
  ];
};